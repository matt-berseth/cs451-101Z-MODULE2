...
## DIM REDUCITON ##
# what if we shaved off the border pixels?
X = X.reshape((X.shape[0], 28, 28))
logging.info(f"X.shape: {X.shape}")
n_pixles_to_shave_off = 5 # TODO: change this!
X = X[:, n_pixles_to_shave_off:, n_pixles_to_shave_off:]
...
mlp = MLPClassifier(hidden_layer_sizes=(10), learning_rate_init=.001, random_state=0)
